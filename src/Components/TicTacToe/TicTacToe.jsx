...
const TicTacToe = () => {
  ...
  const won = (winner) => {
    setLock(true);
    if (winner === "x") {
      titleRef.current.innerHTML = `The Winner is : <img src = ${cross_icon} wins />`;
    } else {
      titleRef.current.innerHTML = `The Winner is : <img src = ${circle_icon} wins/>`;
    }
  }
  ...
  return (
      ...
      <div className="container">
          ...
          <div className="board">
            <div className="row1">
              <div className="boxes" ref={box0} onClick={(e) => {
                  toggle(e, 0);
                }}
              ></div>
              <div
